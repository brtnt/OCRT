...
rem ==========================================================================
rem  OCRT polarization sensitivity run - part 3 of 3
rem
...
rem  machine. Each part writes its own index_part3of3.csv, so they never
rem  overwrite each other.
rem
rem  Usage (PowerShell needs the leading .\ ):
rem    .\run_part3.bat --verify     check the executable first (do this once)
rem    .\run_part3.bat --dry-run    show the plan only
rem    .\run_part3.bat              run this part
rem
