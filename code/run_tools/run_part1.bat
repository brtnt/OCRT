...
rem ==========================================================================
rem  OCRT polarization sensitivity run - part 1 of 3
rem
...
rem  machine. Each part writes its own index_part1of3.csv, so they never
rem  overwrite each other.
rem
rem  Usage (PowerShell needs the leading .\ ):
rem    .\run_part1.bat --verify     check the executable first (do this once)
rem    .\run_part1.bat --dry-run    show the plan only
rem    .\run_part1.bat              run this part
rem
